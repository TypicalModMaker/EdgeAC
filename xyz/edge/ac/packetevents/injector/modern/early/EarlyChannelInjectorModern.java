...
public class EarlyChannelInjectorModern implements EarlyInjector
{
    ...
    public EarlyChannelInjectorModern() {
                ...
                if (value instanceof List) {
                    final List listWrapper = new ListWrapper((List)value) {
                        ...
                        public void processAdd(final Object o) {
                            if (o instanceof ChannelFuture) {
                                try {
                                    EarlyChannelInjectorModern.this.injectChannelFuture((ChannelFuture)o);
                                }
                                catch (final Exception ex) {
                                    ex.printStackTrace();
                                }
    ...
    private void injectChannelFuture(final ChannelFuture channelFuture) {
        ...
        try {
            final ChannelInitializer<?> oldChannelInitializer = (ChannelInitializer<?>)bootstrapAcceptorField.get(bootstrapAcceptor);
            final ChannelInitializer<?> channelInitializer = new PEChannelInitializerModern(oldChannelInitializer);
            bootstrapAcceptorField.setAccessible(true);
    ...
    public void eject() {
        ...
        for (final ChannelFuture future : this.injectedFutures) {
            ...
            try {
                ...
                if (!(oldInit2 instanceof PEChannelInitializerModern)) {
                    continue;
                }
                childHandlerField.setAccessible(true);
                childHandlerField.set(bootstrapAcceptor, ((PEChannelInitializerModern)oldInit2).getOldChannelInitializer());
            }
    ...
    public boolean hasInjected(final Player player) {
        ...
        final PlayerChannelHandlerModern handler = this.getHandler(channel);
    ...
    private PlayerChannelHandlerModern getHandler(final Object rawChannel) {
    ...
    public void updatePlayerObject(final Player player, final Object rawChannel) {
        final PlayerChannelHandlerModern handler = this.getHandler(rawChannel);
        if (handler != null) {
