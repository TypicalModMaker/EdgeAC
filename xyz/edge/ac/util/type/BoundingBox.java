...
public final class BoundingBox
{
    ...
    public BoundingBox(final User player) {
        this.minX = player.getMovementHandler().getX() - 0.3;
        this.minY = player.getMovementHandler().getY();
        this.minZ = player.getMovementHandler().getZ() - 0.3;
        this.maxX = player.getMovementHandler().getX() + 0.3;
        this.maxY = player.getMovementHandler().getY() + 1.8;
        this.maxZ = player.getMovementHandler().getZ() + 0.3;
    }
    ...
    public double collidesD(final RayTrace ray, double tmin, double tmax) {
        for (int i = 0; i < 3; ++i) {
            final double d = 1.0 / ray.direction(i);
            double t0 = (this.min(i) - ray.origin(i)) * d;
            double t2 = (this.max(i) - ray.origin(i)) * d;
            if (d < 0.0) {
                final double t3 = t0;
                t0 = t2;
                t2 = t3;
