        ...
        if (check != null) {
            new Thread(() -> {
                ...
                while (iterator.hasNext()) {
                    final User allUser = iterator.next();
                    allUser.getChecks().iterator();
                    final Iterator iterator2;
                    while (iterator2.hasNext()) {
                        final EdgeCheck checkAll = iterator2.next();
                ...
                while (iterator3.hasNext()) {
                    final User playerData = iterator3.next();
                    playerData.getChecks().iterator();
                    final Iterator iterator4;
                    while (iterator4.hasNext()) {
                        final EdgeCheck checkOf = iterator4.next();
